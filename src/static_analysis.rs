...
// `FileLanguage` moved to `rag::file_language` (2026-05-23).
// Re-exported here so the historical path `crate::static_analysis::FileLanguage`
// keeps working for in-tree callers (`prompt_tier.rs`, etc.) and
// external `rustcode::static_analysis::FileLanguage` consumers.
pub use rag::FileLanguage;
